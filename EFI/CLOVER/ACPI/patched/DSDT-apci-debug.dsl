 ...
 *
 * Disassembly of iASLVxiKrC.aml, Mon May 21 12:20:06 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00011201 (70145)
...
DefinitionBlock ("", "DSDT", 1, "HPQOEM", "SLIC-MPC", 0x00000000)
{
    ...
    External (_PR_.CPU0.CTLD, MethodObj)    // 0 Arguments (from opcode)
    ...
    External (HBRT, MethodObj)    // 1 Arguments (from opcode)
    ...
    Name (DPPL, 0x8000)
    OperationRegion (GNVS, SystemMemory, 0xAAFB7C98, 0x0204)
    ...
    OperationRegion (OGNS, SystemMemory, 0xAAFB5018, 0x12EC)
    ...
    OperationRegion (FGNS, SystemMemory, 0xAAFBED98, 0x010D)
    ...
    OperationRegion (HBFS, SystemMemory, 0xAAFBC018, 0x1000)
    ...
    OperationRegion (HBFT, SystemMemory, 0xAAFBA018, 0x1000)
    Field (HBFT, ByteAcc, Lock, Preserve)
    {
        TBUF,   32768
    }

    OperationRegion (HNBD, SystemMemory, 0xAAFB9F98, 0x28)
    ...
    OperationRegion (MDBG, SystemMemory, 0xAAFB2018, 0x1004)
